...
- [Testnet consensus](testnet-consensus.md) — deterministic committee/proposer/finality rules and v0.10 CARROT genesis commitment.
...
7. CARROT v0.10 is capped at 21,000,000 with 8 decimals and a fixed 20/60/10/5/5 allocation; the founder allocation has a one-year cliff/four-year vest.
...
11. v0.10 is testnet/specification work only: no economically valuable CARROT, token sale, or production treasury spending is activated.
